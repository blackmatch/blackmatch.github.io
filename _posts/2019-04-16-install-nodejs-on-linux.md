---
layout: post
title: "在Linux系统上通过二进制包安装Node.js"
---
...
在Node.js官方的发布网站[https://nodejs.org/dist/](https://nodejs.org/dist/)下载合适的二进制包，比如我要安装`v11.14.0`版本，我需要下载二进制包为[node-v11.14.0-linux-x64.tar.gz](https://nodejs.org/dist/v11.14.0/node-v11.14.0-linux-x64.tar.gz)。
