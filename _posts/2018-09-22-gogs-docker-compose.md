...
根据官方文档的安装步骤一步一步搭建即可。但是，偷懒是程序员的必备技能之一啊！其实，搭建就分两部分：Gogs主程序和数据库。Gogs主程序官方提供了Docker镜像，数据库也能找到对应的Docker镜像，于是自然而然就能想到Docker三剑客之一的Docker Compose。大家可以使用我写的一个docker-compose.yml文件（数据库使用的是MySQL），地址是：[https://github.com/blackmatch/gogs-docker-compose](https://github.com/blackmatch/gogs-docker-compose)，几分钟就能轻松搭建好。

## 一些截图

从官网搬来几张截图供大家欣赏：

![11]({{ site.url }}/images/gogs-docker-compose/11.png)

![22]({{ site.url }}/images/gogs-docker-compose/22.png)

![33]({{ site.url }}/images/gogs-docker-compose/33.png)
